...
// In order to understand more this code, review https://www.youtube.com/watch?v=PeUERQJnHdI video,
// minute 46.

// This class is used to go back from the router, it uses handlers with dispatchers
