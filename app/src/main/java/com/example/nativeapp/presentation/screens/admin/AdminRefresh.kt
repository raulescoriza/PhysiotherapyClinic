...
/**
 * Same class to AdminHomScreen, it only helps to reload the changes done.
 * I would like to do in other way
 */
@Composable
fun AdminRefresh(editProfileViewModel: EditProfileViewModel = viewModel()
) {
